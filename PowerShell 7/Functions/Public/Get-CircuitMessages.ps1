...
Param (
        ...
        [string]$ItemID
                ...
                Invoke-RestMethod -URI "$uri" -Method Get -Headers $postdata} else {$GetProxy = powershell.exe -command "& {[System.Net.WebRequest]::GetSystemWebproxy().GetProxy('$uri').OriginalString}"
